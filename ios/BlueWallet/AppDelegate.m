...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  NSUserDefaults *defaults = [[NSUserDefaults alloc] initWithSuiteName:@"group.at.frhlch.cdtm.bluewallet"];
  [defaults setValue:@{@"activityType": @"at.frhlch.cdtm.bluewallet.receiveonchain", @"userInfo": @{@"address": @""}} forKey:@"onUserActivityOpen"];
  */
  return YES;
}
